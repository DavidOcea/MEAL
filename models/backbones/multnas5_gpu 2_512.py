...
class ProxylessNASNets(BasicUnit):
    ...
    def __init__(self, first_conv, blocks, feature_mix_layer, classifier):
        ...
        self.global_avg_pooling = nn.AdaptiveAvgPool2d(1) #注意力机制
    ...
    def forward(self, x):
        ...
        x = self.global_avg_pooling(x)        #注意力机制
        x = x.view(x.size(0), -1)  # flatten  #注意力机制
        # x = self.classifier(x)
        return x
...
if __name__ == '__main__':
    ...
    model = multnas5_gpu_2_512(num_classes=1000)
