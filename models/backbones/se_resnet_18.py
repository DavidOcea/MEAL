...
__all__ = ['SENet', 'senet154', 'se_resnet50_18', 'se_resnet101', 'se_resnet152',
...
class SENet(nn.Module):
    ...
    def __init__(self, block, layers, groups, reduction, dropout_p=0.2,
        ...
        self.layer4_l = nn.Conv2d(512 * block.expansion, 18, kernel_size=1, bias=False,stride=1)
...
def se_resnet50_18(num_classes=1000):
...
def se_resnext101_64x4d(num_classes=1000):
